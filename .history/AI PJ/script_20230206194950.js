...
let mic = document.querySelectorAll(".bi");
...
const canvas = document.getElementById("canvas");
    ...
    navigator.mediaDevices.getUserMedia(constraints)
      .then(stream => {
        ...
        video.onloadedmetadata = () => {
          video.play();
          canvas.width = video.wi;
          canvas.height = video.wi;
        };
    ...
    document.getElementById("caption").addEventListener("click", takePicture);
