...
function playPause(p){
    if(p == true){
        document.querySelector(".bungkus").innerHTML = `<button type="button" onclick="" class="btn" id="Mulai">
        <span>
        ...
        document.querySelector(".bungkus").innerHTML = `
        <button type="button" onclick="" class="btn" id="Pause">
        <span>
