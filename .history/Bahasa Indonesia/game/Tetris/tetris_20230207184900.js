...
function playPause(p){
    if(p == true){
        document.querySelector(".tmbl").innerHTML = `<button type="button" onclick="" class="btn" id="Mulai">
        <span>
        ...
        document.querySelector(".tmbl").innerHTML = `<button type="button" onclick="" class="btn" id="Pause">
        <span>
